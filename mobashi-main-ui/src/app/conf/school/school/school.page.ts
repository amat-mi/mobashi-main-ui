...
export class SchoolPage implements OnInit {
  ...
  readonly school$ = this.service.schoolByID(this.activatedRoute.paramMap, 'id');
  ...
  ionViewWillEnter() {
    this.confService.setMenuDataComplex(this.activatedRoute.data, this.schools$, '/conf/schools', { labelName: 'name' });
  }
